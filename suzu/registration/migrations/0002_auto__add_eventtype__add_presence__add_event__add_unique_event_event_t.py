...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'registration_eventtype', (
        ...
        db.send_create_signal(u'registration', ['EventType'])

        # Adding model 'Presence'
        db.create_table(u'registration_presence', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Event'])),
            ('begin_date_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('yokoshi', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Yokoshi'])),
            ('additional_information', self.gf('django.db.models.fields.TextField')(max_length=2000)),
        ))
        db.send_create_signal(u'registration', ['Presence'])

        # Adding model 'Event'
        db.create_table(u'registration_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.EventType'])),
            ('begin_date_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('details', self.gf('django.db.models.fields.CharField')(max_length=20000, null=True, blank=True)),
        ))
        db.send_create_signal(u'registration', ['Event'])

        # Adding unique constraint on 'Event', fields ['event_type', 'begin_date_time']
        db.create_unique(u'registration_event', ['event_type_id', 'begin_date_time'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['event_type', 'begin_date_time']
        db.delete_unique(u'registration_event', ['event_type_id', 'begin_date_time'])

        # Deleting model 'EventType'
        db.delete_table(u'registration_eventtype')

        # Deleting model 'Presence'
        db.delete_table(u'registration_presence')

        # Deleting model 'Event'
        db.delete_table(u'registration_event')
