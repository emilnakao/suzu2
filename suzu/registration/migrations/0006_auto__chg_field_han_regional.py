...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Han.regional'
        db.alter_column(u'registration_han', 'regional_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Regional'], null=True))

    def backwards(self, orm):

        # Changing field 'Han.regional'
        db.alter_column(u'registration_han', 'regional_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['registration.Regional']))
