...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Yokoshi.last_registration_update'
        db.add_column(u'registration_yokoshi', 'last_registration_update',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Yokoshi.last_registration_update'
        db.delete_column(u'registration_yokoshi', 'last_registration_update')
    ...
    models = {
        ...
        u'registration.han': {
            ...
            'regional': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['registration.Regional']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'registration.yokoshi': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indication': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['registration.Yokoshi']", 'null': 'True', 'blank': 'True'}),
            ...
            'last_registration_update': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
