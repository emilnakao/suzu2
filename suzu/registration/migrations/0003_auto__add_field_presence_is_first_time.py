...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Presence.is_first_time'
        db.add_column(u'registration_presence', 'is_first_time',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Presence.is_first_time'
        db.delete_column(u'registration_presence', 'is_first_time')
